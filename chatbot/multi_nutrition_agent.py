...
calorie_agent_with_search = Agent(
    ...
    * You follow this workflow:
        ...
        1) If you couldn't find the exact match for the food or you need to look up the ingredients, search the web using WebSearch tool to figure out the exact ingredients of the meal.
    ...
    * Even if you know the recipe of the meal, always use WebSearch tool to find the exact recipe and ingredients.
